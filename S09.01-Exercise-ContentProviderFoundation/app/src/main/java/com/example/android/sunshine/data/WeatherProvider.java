...
//  c (5) Create static constant integer values named CODE_WEATHER & CODE_WEATHER_WITH_DATE to identify the URIs this ContentProvider can handle
    public static final int CODE_WEATHER = 100;
    public static final int CODE_WEATHER_WITH_DATE = 101;
//  c (7) Instantiate a static UriMatcher using the buildUriMatcher method
    private static final UriMatcher sUriMatcher = buildUriMatcher();
    WeatherDbHelper mOpenHelper;

//  c (6) Write a method called buildUriMatcher where you match URI's to their numeric ID
...
//  c (1) Implement onCreate
    @Override
    public boolean onCreate() {
//      c (2) Within onCreate, instantiate our mOpenHelper
        mOpenHelper = new WeatherDbHelper(getContext());
//      c (3) Return true from onCreate to signify success performing setup
        return true;
    }
...
//  c (8) Provide an implementation for the query method
    /**
