...
//  c (1) Declare a private static boolean field called sInitialized
    ...
    //  c (4) If the method body is executed, set sInitialized to true
    //  c (5) Check to see if our weather ContentProvider is empty
    //  c (6) If it is empty or we have a null Cursor, sync the weather now!
